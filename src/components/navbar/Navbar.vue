...
const category = [
    { id: 1, keyWords: "Elektronika" },
    { id: 2, keyWords: "Maishiy texnika" },
    { id: 3, keyWords: "Kiym" },
    { id: 4, keyWords: "Poyabzallar" },
    { id: 5, keyWords: "Aksesuarlar" },
    { id: 6, keyWords: "Gozallik va parvarish" },
    { id: 7, keyWords: "Salomatlik" },
    { id: 8, keyWords: "Yana" },
];
            ...
            <div class="navbar__top">
                <div class="navbar__top-item">
                    <div class="navbar__top-item-box">
                        ...
                        <a href="https://uzum.uz/uz/about/delivery-points" class="navbar__top-getZone">{{ $t("give-zone") }}</a>
                    </div>
                </div>
                <div class="navbar__top-item">
                    <div class="navbar__top-item-box2">
                        <a href="https://seller.uzum.uz/" class="navbar__top-sallInUzum">{{ $t("buy-for-uzum") }}</a>
                        <a href="https://uzum.uz/uz/faq" class="navbar__top-questions">{{ $t("questions") }}</a>
                        ...
                        <div class="navbar__top-dropdown">
                            ...
                            <ul class="navbar__top-menu" :class="{ active: dropdownActive }">
                                <li class="navbar__top-menu-link" @click="language('RU')" v-show="!languageRu">
                                    <IconRussian :size="20" />
                                    {{ $t("ru") }}
                                </li>
                                <li class="navbar__top-menu-link" @click="language('UZ')" v-show="!languageUz">
                                    <IconUzbekistan :size="20" />
                                    {{ $t("uz") }}
                                </li>
                            </ul>
    ...
    <div class="container">
        <nav class="navbar">
            ...
            <div class="navbar-item">
                <input class="navbar-search" v-model="searchFilter" @keydown.enter="search" type="text" :placeholder="$t('input-text')" />
            ...
            <div class="navbar-item2">
                ...
                <RouterLink to="/favorite/">
                    <button class="navbar-fav"><IconNavHeard /> {{ $t("favorite") }}</button>
                </RouterLink>
